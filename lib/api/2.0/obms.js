...
var restMidware = injector.get('Http.Services.RestApi');

function getObmsLibrary(req, res) {
    // return restMidware(function (){
    //     return res.json(obms);
    // });
    return res.json(obms);
}